  ...
  <body>
    ...
    <div class="collapse navbar-collapse" id="navbarText">
        ...
        <div class="container" style="margin-top: 20px;">
            ...
            <form id="deleteForm" method="POST" action="delete_subject_handler.php" name="deleteSubjectForm">
...
//}
    ...
    //This array will initialize array of subjects needed to populate drop down set [line: 97-100]
       /// $subjectOptions = array(
        //    "english" => "english",
        //    "math" => "math",
         //   "physics" => "physics",
...
<form id="deleteForm" action="delete_subject_handler.php" name="deleteSubjectForm"  method="post">
...
<input type="hidden" name="userRole" value="<?php // echo $userRole; ?>">  
  ...
  <div class="form-group row">
    ...
    <small id="deleteHelp" class="form-text text-muted">Choose which subject you would like to delete.</small>

    <div class="col-sm-10">
        <select  type="select" id="subject" class="form-control" name="subjects[]" multiple>
               <?php  
                     //   foreach($subjectOptions as $key => $value)
                     //   {       ?>
                                <option value="<?php // echo $value; ?>"><?php // echo $value; ?></option>
