...
<html lang="en">
  <head>
    ...
    <title>The 'Quiz' Application</title>
  </head>
  <body >
    ...
    <div class="container" style="margin-top: 20px;">
        ...
        <form id="loginForm" action="login_handler.php" method="POST" name="loginForm">
...
<!--
                ...
                <form id="loginform" action="login_handler.php" name="loginForm"  method="post">
                  <div class="form-group row">
                    <label for="inputEmail3" class="col-sm-2 col-form-label" >Email</label>
                    <div class="col-sm-10">
                  ...
                  <div class="form-group row">
                    <div class="col-sm-10">
                  <button type="submit" class="btn btn-primary" id="loginButton" name="loginButton" value="1">Login</button>
                    </div>
                </div>

                <div class="form-group row" onclick="toggleSignup();">
                    <div class="col-sm-10">
                <p id="toggleMessage"><a href="#" id="toggleMessageTag" style="text-align: center; font-size: 1 rem; color: black;"><b>If you don't have an account click to signup</b></a></p>    </div>
                </div>
