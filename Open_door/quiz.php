...
<html lang="en">
  <head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    <meta name="viewport" ntent="width=device-width, initial-scale=1, shrink-to-fit=no">
  ...
  <body>
    ...
    <div class="collapse navbar-collapse" id="navbarText">
        ...
        <div class="container" style="margin-top: 20px;">
            ...
            <form id="questionForm" method="POST" action="question_handler.php" name="questionForm" enctype="multipart/form-data">
...
// session_start();
   //        $title = "QUIZ";
    ...
    //    }
      ...
      //          $query = "SELECT * FROM training_quiz.questions WHERE 'subject' = '$subject'";
...
<div class="container" style="margin-top: 20px">
                ...
                <form id="questionForm" action="quiz_handler.php" name="questionForm" enctype="multipart/form-data"  method="post">
                        <input type="hidden" name="subject" value="<?php // echo $subject; ?>">  
                        <input type="hidden" name="questionNumber" value="<?php // echo $questionNumber; ?>">  
                        <input type="hidden" name="userRole" value="<?php // echo  $userRole; ?>">  
             <div class="form-group row" style="margin-bottom: 15px;">
